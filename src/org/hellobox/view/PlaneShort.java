...
public class PlaneShort extends BaseShape
{
	...
	private int SSCOPEX = Utils.SCOPEX + 10;
	...
	public PlaneShort(Context context)
	{
		super(context);
	}
	
	public PlaneShort(Context context, AttributeSet attributeSet)
	{
		super(context, attributeSet);
	}


	public PlaneShort(Context context, int x , int y)
	{
		super(context);
		this.currentx = x;
		this.currenty = y;
